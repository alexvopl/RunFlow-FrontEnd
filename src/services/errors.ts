export const GAME_ERRORS: Record<string, string> = {
    ...
    PRIVATE_CLAN:                 "Ce clan est privé. Rejoins via un code d'invitation.",
    NAME_TAKEN:                   'Ce nom de clan est déjà utilisé.',
    NOT_MEMBER:                   "Tu n'es pas membre de ce clan.",
    CANNOT_KICK_SELF:             'Utilise "Quitter" pour quitter le clan.',
